...
export const meta: MetaFunction = () => {
  return {
    title: `PrviacyPolicy - ${configuration.site.siteName}`,
  };
};
    ...
    <div>
      <Container>
        <div className={'flex flex-col space-y-14'}>
          ...
          >
            <div>
              At Brandwise, accessible from usebrandwise.xyz, one of our main
              priorities is the privacy of our visitors. This Privacy Policy
              document contains types of information that is collected and
              recorded by Brandwise and how we use it. If you have additional
              ...
              Brandwise. This policy is not applicable to any information
            ...
            <div>
              Brandwise follows a standard procedure of using log files. These
            ...
            <div>
              Brandwise's Privacy Policy does not apply to other advertisers or
            ...
            <div>
              ...
              activity. Brandwise does not knowingly collect any Personal
